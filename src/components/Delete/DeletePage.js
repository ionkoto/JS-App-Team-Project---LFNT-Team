    ...
    render() {
        return (
            <div>
                ...
                <button className="btn btn-warning" onClick={this.onDeleteSubmitHandler} >Delete</button>
                <button className="btn btn-primary" onClick={this.onCancelSubmitHandler} >Cancel</button>
            </div>
        );
    }
}
